// Vendored from Organized-AI/ai-work-assessment (src/validate.js, helper v8.0.0).
// Pure ESM, no Node APIs. Re-vendor when the contract changes; the intake in
// proof.ts calls assertNoSecrets, assertNoLocalEvidenceLeaks, validateRawProfileV9,
// sanitizeProfile, validateProfileV9 — the same sequence bin/cli.mjs runs.
